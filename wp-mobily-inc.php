...
function mobily_pro_notification(){
	if (get_option('mobily_hide_pro_notice') != 'yes'){
       ...
       <p><b>Thanks for install WP-Mobily</b>. Click <a href="https://hardani.de/" target="_blank">here</a><br> for details.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="options-general.php?page=wp-mobily/wp-mobily-inc.php&hidemsg=1">Hide This Message</a></p>
	   </div>';
	}
}
